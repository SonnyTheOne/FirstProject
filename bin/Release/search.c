        ...
        if(w==1)
        {
            ...
            while(!feof(fp))
            {
                ...
                if(strcmp(kk,p->name)==0)
                {
                    ...
                    if(p->MathScore!=-1)
                    {
                        printf("高数；%d ",p->MathScore);
                    }
                    if(p->EnglishScore!=-1)
                    {
                        printf("英语；%d ",p->EnglishScore);
                    }
                    if(p->CScore!=-1)
                    {
                        printf("C语言；%d ",p->CScore);
                    }
                    if(p->CPPScore!=-1)
                    {
                        printf("C++；%d ",p->CPPScore);
                    }
                    if(p->LinearAlgebra!=-1)
                    {
                        printf("线性代数；%d ",p->LinearAlgebra);
                    }
                    if(p->Physics!=-1)
                    {
                    ...
                    if(p->History!=-1)
                    {
                        printf("历史；%d ",p->History);
                    }
                    if(p->MilitaryTheory!=-1)
                    {
                        printf("军事理论；%d ",p->MilitaryTheory);
                    }
                }
            }
